            ...
            children: [
              ...
              Flexible(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text( "Title"*10,maxLines: 2,overflow: TextOverflow.ellipsis,),
                    FittedBox(
                      child: Row(
                        children: [
                    ...
                    const FittedBox(child:  SubtitleTextWidget(label: "166.5\$",textDecorations: TextDecoration.none,color: Colors.blue,)),
